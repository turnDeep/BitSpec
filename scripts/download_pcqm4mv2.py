...
def download_pcqm4mv2(data_dir: str = "data/pcqm4mv2"):
    ...
    try:
        ...
        logger.info("Note: Downloading SMILES only (graph conversion done during training)")
        # Use only_smiles=True to avoid graph conversion errors
        dataset = PCQM4Mv2Dataset(root=str(data_path), only_smiles=True)
